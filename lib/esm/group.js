...
import { parseErrorResponse, InvalidURIException } from "./exception";
import { isSuccess } from "./httpResponse";
import { error, validateGroupID } from "./utilities";
/**
...
export class KiiGroup {
    ...
    /** @hidden */
    static groupWithJSON(obj, app = KiiApplication.globalApp) {
        ...
        if (obj["owner"] != null) {
            const owner = KiiUser.userWithID(obj["owner"]);
     ...
     * ```
     */
    static registerGroupWithID(groupID, groupName, members, app = KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentUser = app.getCurrentUser();
            if (currentUser === null) {
                throw error("owner is null", this);
            }
            if (groupID === null || groupID.length == 0) {
                throw error("groupID is null or empty", this);
            }
            if (!validateGroupID(groupID)) {
                throw error(`invalid groupID : ${groupID}`, this);
            }
            if (groupName.length == 0) {
                throw error("groupName is null or empty", this);
            }
    ...
    /** @hidden */
    static registerGroupWithIDAndOwner(groupID, groupName, owner, members, app = KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            if (groupID === null || groupID.length == 0) {
                throw error("groupID is null or empty", this);
            }
    ...
    removeUser(member) {
        ...
        if (userId == null || userId.length == 0) {
            //TODO print log or throw error?
            throw error("User ID is null", this);
        }
    ...
    getMemberList() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isSuccess(response.status)) {
                ...
                return members.map((member) => KiiUser.userWithID(member["userID"], this.app));
            }
            else {
    ...
    changeGroupName(newName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (groupId.length == 0) {
                throw error("Invalid group. Save the group on the server before updating the name.", this);
            }
            if (newName.trim().length == 0) {
                throw error("Invalid group name.", this);
            }
    ...
    saveWithOwner(owner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (groupId.length == 0) {
                if (owner.length == 0) {
                    throw error("Owner ID must not be empty.", this);
                }
    ...
    createGroup(ownerId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isSuccess(response.status)) {
                ...
                this.setId(groupId);
                if (ownerId) {
                    this.setOwner(KiiUser.userWithID(ownerId));
                }
            }
            else {
                throw parseErrorResponse(request, response, this, null);
    ...
    refresh() {
        return __awaiter(this, void 0, void 0, function* () {
            const groupId = this.getID();
            if (groupId.length == 0) {
                throw error("This group does not have ID.", this);
            }
     ...
     * ```
     */
    static groupWithName(groupName, app = KiiApplication.globalApp) {
        const group = new KiiGroup(app);
        group.setName(groupName);
        return group;
    }
     ...
     * ```
     */
    static groupWithNameAndMembers(groupName, members, app = KiiApplication.globalApp) {
        const group = new KiiGroup(app);
        group.setName(groupName);
        members.forEach((member) => {
            const userId = member.getID();
     ...
     * ```
     */
    static groupWithID(groupID, app = KiiApplication.globalApp) {
        const group = new KiiGroup(app);
        group.setId(groupID);
        return group;
    }
     ...
     * ```
     */
    static groupWithURI(uri, app = KiiApplication.globalApp) {
