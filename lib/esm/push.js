...
export class KiiPushSubscription {
    ...
    unsubscribe(target) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isSuccess(response.status)) {
                ...
                throw parseErrorResponse(request, response, target, null);
            }
        });
    }
    /**
    ...
    getRequestHTTPURI(target) {
        let subscriberPath = "";
        if (this.subscriber instanceof KiiUser) {
            subscriberPath = `users/${this.subscriber.getID()}`;
        }
        if (this.subscriber instanceof KiiThing) {
...
export class KiiPushInstallation {
    ...
    installGcm(installationRegistrationID, development) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!isNonEmptyString(installationRegistrationID)) {
                throw error("installationRegistrationID must not be null or empty.", this);
            }
    ...
    installApns(deviceToken, development) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!isNonEmptyString(deviceToken)) {
                throw error("deviceToken must not be null or empty.", this);
            }
    ...
    getMqttEndpoint(installationID) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!isNonEmptyString(installationID)) {
                throw error("installationID must not be null or empty.", this);
            }
    ...
    uninstall(installationRegistrationID, deviceType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.validateDeviceType(deviceType)) {
                throw error(`Unsupported deviceType ${deviceType}`, this);
            }
    ...
    install(installationRegistrationID, deviceType, development) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof development !== "boolean") {
                throw error("type of development must be boolean.", this);
            }
