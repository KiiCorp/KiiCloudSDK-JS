...
export class KiiACL {
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (keys.length == 0) {
                throw error("There is no entry to save.", this);
            }
     ...
     */
    static aclWithParent(parent, app = KiiApplication.globalApp) {
...
const itemToSubject = (item) => {
    if (item["groupID"] != null) {
        ...
        return KiiGroup.groupWithID(groupId);
    }
