...
import { KiiEncryptedBucket } from "./bucket";
import { InvalidPasswordException, InvalidUserIdentifierException, InvalidUsernameException, parseErrorResponse, InvalidDisplayNameException, InvalidEmailException, InvalidPhoneNumberException, InvalidURIException, IllegalStateException, UnsupportedOperationException, InvalidCountryException, } from "./exception";
...
import { isCallback, isGlobalPhoneNumber, isNonEmptyString, trim, validateCountryCode, validateDisplayName, validateEmail, validateLocalPhone, validatePassword, validatePhoneNumber, validateUsername, } from "./utilities";
import { error, safeCalculateExpiresAtAsNumber, safeCalculateExpiresAtAsDate, } from "./utilities";
...
export class KiiUser {
    ...
    setDisplayName(value) {
        if (!validateDisplayName(value)) {
            throw new InvalidDisplayNameException(undefined, this);
        }
     ...
     */
    setCountry(value) {
        if (!this.country || !validateCountryCode(this.country)) {
     ...
     */
    set(key, value) {
        if (!isNonEmptyString(key) || key.substr(0, 1) == "_") {
            return;
        }
     ...
     * ```
     */
    static getCurrentUser(app = KiiApplication.globalApp) {
     ...
     * ```
     */
    static userWithUsername(username, password, app = KiiApplication.globalApp) {
     ...
     * ```
     */
    static userWithPhoneNumber(phoneNumber, password, app = KiiApplication.globalApp) {
        const user = new KiiUser(app);
     ...
     * ```
     */
    static userWithPhoneNumberAndUsername(phoneNumber, username, password, app = KiiApplication.globalApp) {
        const user = new KiiUser(app);
        user.setUsername(username);
        user.setPassword(password);
        user.setPhoneNumber(phoneNumber);
     ...
     * ```
     */
    static userWithEmailAddress(emailAddress, password, app = KiiApplication.globalApp) {
        const user = new KiiUser(app);
        user.setPassword(password);
     ...
     * ```
     */
    static userWithEmailAddressAndUsername(emailAddress, username, password, app = KiiApplication.globalApp) {
        const user = new KiiUser(app);
        user.setUsername(username);
        user.setPassword(password);
        user.setEmailAddress(emailAddress);
     ...
     * ```
     */
    static userWithEmailAddressAndPhoneNumber(emailAddress, phoneNumber, password, app = KiiApplication.globalApp) {
        const user = new KiiUser(app);
        user.setPassword(password);
        user.setEmailAddress(emailAddress);
        user.setPhoneNumber(phoneNumber);
     ...
     * ```
     */
    static userWithCredentials(emailAddress, phoneNumber, username, password, app = KiiApplication.globalApp) {
        const user = new KiiUser(app);
        user.setUsername(username);
        user.setPassword(password);
        user.setEmailAddress(emailAddress);
     ...
     * ```
     */
    static userWithID(userID, app = KiiApplication.globalApp) {
        const user = new KiiUser(app);
        user.setId(userID);
        return user;
    }
     ...
     * ```
     */
    static userWithURI(uri, app = KiiApplication.globalApp) {
        const user = new KiiUser(app);
        ...
        if (uuid) {
            ...
            throw new InvalidURIException(undefined, undefined);
        }
        return user;
    }
    /**
     ...
     * ```
     */
    static authenticate(userIdentifier, password, app = KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result.expiresAt) {
                ...
                const expiresAt = safeCalculateExpiresAtAsDate(result.expiresAt, currentTime);
     ...
     * ```
     */
    static authenticateWithToken(token, expiresAt, app = KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * ```
     */
    static authenticateWithTotp(totpCode, app = KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = {
                grant_type: "mfa",
                totp_code: totpCode,
            ...
            if (response.status != 200) {
                throw parseErrorResponse(request, response, new KiiUser(app), null);
            }
            const user = new KiiUser(app);
            user.updateWithJSON(response.body);
            return user;
     ...
     * ```
     */
    static authenticateWithRecoveryCode(recoveryCode, app = KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = {
                grant_type: "mfa",
    ...
    register() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (password == null) {
                throw error("password is not set", this);
            }
     ...
     * ```
     */
    static registerAsPseudoUser(userFields = {}, app = KiiApplication.globalApp) {
        return __awaiter(this, arguments, void 0, function* () {
            // sustain the compatibility with v2
            if (isCallback(arguments[0])) {
                userFields = arguments[1];
                app = arguments[2] || KiiApplication.globalApp;
            }
    ...
    putIdentity(identityData, password, userFields = {}, removeFields = []) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.isPseudoUser()) {
                throw new IllegalStateException("This user has the identity already", this);
            }
            const currentUser = this.app.getCurrentUser();
            if (currentUser == null || currentUser.getAccessToken() == null) {
                throw new IllegalStateException("User is not logged in", this);
            }
            // validate values and throw exception
            validateIdentityData(identityData);
            if (!hasIdentityData(identityData)) {
                throw new IllegalStateException("needs to provide at least one of login name, email address or phone number", this);
            }
            if (!validatePassword(password)) {
                throw new IllegalStateException("invalid password", this);
            }
            ...
            if ((identityData === null || identityData === void 0 ? void 0 : identityData.phoneNumber) != null) {
                if (!this.isValidLocalPhoneNumber(identityData.phoneNumber, country)) {
                    throw new IllegalStateException("needs to provide country for the local phone number", this);
                }
            }
    ...
    update(identityData = {}, userFields = {}, removeFields = []) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!hasParameter(identityData, userFields, removeFields, hasIdentity)) {
                throw new IllegalStateException("all arguments are null or empty", this);
            }
            const country = userFields === null || userFields === void 0 ? void 0 : userFields.country;
            if ((identityData === null || identityData === void 0 ? void 0 : identityData.phoneNumber) != null) {
                if (!this.isValidLocalPhoneNumber(identityData.phoneNumber, country)) {
            ...
            if (user.isPseudoUser() && hasIdentity) {
                throw new IllegalStateException("Pseudo user must use putIdentity()", this);
            }
            const data = deepCopy(user.customInfo);
    ...
    updatePassword(fromPassword, toPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!validatePassword(toPassword)) {
     ...
     * ```
     */
    static resetPassword(userIdentifier, app = KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!validateEmail(userIdentifier)) {
                throw new IllegalStateException("Invalid user identifier. Must be a valid email address", undefined);
            }
     ...
     * ```
     */
    static resetPasswordWithNotificationMethod(userIdentifier, notificationMethod, app = KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof userIdentifier !== "string") {
                throw new IllegalStateException("given userIdentifier is not string", undefined);
            }
            if (userIdentifier.length == 0) {
                throw new IllegalStateException("given userIdentifier is empty", undefined);
            }
            if (notificationMethod !== "EMAIL" &&
                notificationMethod !== "SMS" &&
                notificationMethod !== "SMS_PIN") {
                throw new IllegalStateException("notificationMethod should be 'EMAIL' or 'SMS' or 'SMS_PIN'", undefined);
            }
            const toQualifiedId = (userIdentifier) => {
                if (validateEmail(userIdentifier)) {
                    return `EMAIL:${userIdentifier}`;
                }
                if (isGlobalPhoneNumber(userIdentifier)) {
     ...
     * ```
     */
    static completeResetPassword(userIdentifier, pinCode, newPassword, app = KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            if (userIdentifier.length == 0) {
                throw new IllegalStateException("given userIdentifier is null or empty", undefined);
            }
            if (pinCode.length == 0) {
                throw new IllegalStateException("given pinCode is null or empty", undefined);
            }
            const qualifiedId = toQualifiedId(userIdentifier);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isSuccess(response.status)) {
                ...
                return groups.map((obj) => {
                    return KiiGroup.groupWithJSON(obj);
                });
            }
            else {
                throw parseErrorResponse(request, response, this, null);
    ...
    changeEmail(newEmail) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!validateEmail(newEmail)) {
                throw new IllegalStateException("Invalid email address format", this);
            }
     ...
     * ```
     */
    static logOut(app = KiiApplication.globalApp) {
        app.logOut();
    }
    /**
     ...
     * ```
     */
    static loggedIn(app = KiiApplication.globalApp) {
        return app.loggedIn();
    }
    /**
     ...
     * ```
     */
    static findUserByEmail(email, app = KiiApplication.globalApp) {
        const currentUser = app.getCurrentUser();
        if (currentUser == null || currentUser.getAccessToken() == null) {
            throw new IllegalStateException("User is not logged in", undefined);
        }
        if (email.length == 0) {
            throw new IllegalStateException("email should not null or empty", undefined);
        }
     ...
     * ```
     */
    static findUserByPhone(phone, app = KiiApplication.globalApp) {
        const currentUser = app.getCurrentUser();
        if (currentUser == null || currentUser.getAccessToken() == null) {
            throw new IllegalStateException("User is not logged in", undefined);
        }
        if (phone.length == 0) {
            throw new IllegalStateException("phone should not null or empty", undefined);
        }
     ...
     * ```
     */
    static findUserByUsername(username, app = KiiApplication.globalApp) {
        const currentUser = app.getCurrentUser();
        if (currentUser == null || currentUser.getAccessToken() == null) {
            throw new IllegalStateException("User is not logged in", undefined);
        }
        if (username.length == 0) {
            throw new IllegalStateException("username should not null or empty", undefined);
        }
     ...
     */
    static findUserByUsernameWithoutLogin(username, app = KiiApplication.globalApp) {
        const url = `/apps/${app.getAppID()}/users/LOGIN_NAME:${username}`;
        return KiiUser.findUser(url, app);
    }
    /**
     * @hidden This to be used from admin context
     */
    static findUserByEmailWithoutLogin(username, app = KiiApplication.globalApp) {
     ...
     * @hidden This to be used from admin context
     */
    static findUserByPhoneWithoutLogin(username, app = KiiApplication.globalApp) {
    ...
    topicWithName(topicName) {
        if (topicName.length == 0) {
            throw new IllegalStateException("topicName should not null or empty", this);
        }
        const userId = this.getID();
        if (userId == null || userId.length == 0) {
            throw new IllegalStateException("can not instantiate topic from instance which doesn't have ID", this);
        }
        const uri = `/users/${this.getID()}`;
        return new KiiTopic(uri, topicName, this.app);
    }
    /**
    ...
    pushInstallation() {
        if (this.app.isAdmin()) {
            throw new UnsupportedOperationException("UnsupportedOperationException: Push installation is not supported by admin context", this);
        }
        return new KiiPushInstallation(this, this.app);
    }
    setId(id) {
        this.id = id;
    }
    ...
    setPhoneNumber(phone) {
        if (validatePhoneNumber(phone)) {
            ...
            throw new InvalidPhoneNumberException("Invalid Phone", this);
        }
    }
    /** @hidden */
    setLocalPhone(phone, country) {
        ...
        if (validateCountryCode(country)) {
            ...
            throw new InvalidCountryException("Invalid Coruntry", this);
        }
    }
    /** @hidden */
    ...
    findUserIdentifer() {
        ...
        throw new IllegalStateException("No identifier", this);
    }
    isValidLocalPhoneNumber(phoneNumber, country) {
        if (isGlobalPhoneNumber(phoneNumber)) {
            return true;
        }
        if (country == null) {
            return false;
...
const isValidLocalPhoneNumber = (phoneNumber, country) => {
    if (phoneNumber !== undefined && !isGlobalPhoneNumber(phoneNumber)) {
        if (country == undefined) {
            return false;
        }
        return validateCountryCode(country);
    }
    return true;
};
    ...
    if (data) {
        if (data.emailAddress && data.emailAddress != null) {
            if (!validateEmail(data.emailAddress)) {
                throw new IllegalStateException("invalid email", this);
            }
        }
        if (data.phoneNumber && data.phoneNumber != null) {
            if (!validatePhoneNumber(data.phoneNumber)) {
                throw new IllegalStateException("invalid phone number", this);
            }
        }
        if (data.username && data.username != null) {
            if (!validateUsername(data.username)) {
                throw new IllegalStateException("invalid username", this);
            }
        }
    }
};
