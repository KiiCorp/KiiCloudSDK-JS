...
import { InvalidPasswordException, InvalidUserIdentifierException, InvalidUsernameException, parseErrorResponse, InvalidDisplaynameException, InvalidEmailException, InvalidPhoneNumberException, InvalidURIException, IllegalStateException, } from "./exception";
...
export class KiiUser {
    ...
    pushInstallation() {
        if (this.app.isAdmin()) {
            throw error("UnsupportedOperationException: Push installation is not supported by admin context", this);
        }
    ...
    setLocalPhone(phone, country) {
        ...
        if (validateCountryCode(country)) {
            ...
            throw new InvalidPhoneNumberException("Invalid Coruntry", this);
        }
    }
    /** @hidden */
