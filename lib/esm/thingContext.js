...
import { InvalidArgumentException, InvalidURIException } from "./exception";
import { Kii } from "./kii";
...
export class KiiThingContext {
    ...
    bucketWithName(bucketName) {
        return new KiiBucket(bucketName, null, this.app);
    }
    /**
    ...
    encryptedBucketWithName(bucketName) {
        return new KiiEncryptedBucket(bucketName, null, this.app);
    }
    /**
    ...
    topicWithName(topicName) {
        if (typeof topicName !== "string" || topicName === "") {
            throw new InvalidArgumentException("topicName should not null or empty", this);
        }
    ...
    listTopics(paginationKey) {
        return __awaiter(this, arguments, void 0, function* () {
            ...
            return Kii.listTopics(paginationKey, this.app);
        });
    }
    /**
    ...
    getAuthenticatedThing() {
        const thingContext = KiiThing.thingWithID(this.thingId, this.app);
     ...
     */
    pushInstallation() {
        return new KiiPushInstallation(null, this.app);
    }
    /** @hidden */
    _getToken() {
