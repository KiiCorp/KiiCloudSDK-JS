...
import { InvalidURIException } from "./exception";
/**
...
export class KiiAppAdminContext {
    ...
    bucketWithName(bucketName) {
        const adminBucket = new KiiBucket(bucketName, null, this.app);
        return adminBucket;
    }
    /**
    ...
    encryptedBucketWithName(bucketName) {
        const bucket = new KiiEncryptedBucket(bucketName, null, this.app);
        return bucket;
    }
    /**
    ...
    groupWithName(groupName) {
        const group = KiiGroup.groupWithName(groupName, this.app);
        return group;
    }
    /**
     ...
     */
    userWithID(userid) {
        const user = KiiUser.userWithID(userid, this.app);
        return user;
    }
    /**
    ...
    objectWithURI(objectUri) {
        ...
        if (compLength < 4 || !valid) {
            throw new InvalidURIException(undefined, this);
        }
        const bucketIndex = compLength === 4 ? 1 : 3;
        const bucketName = components[bucketIndex];
        let subject = null;
        if (components[0] === "groups" && compLength === 6) {
            subject = KiiGroup.groupWithID(components[1], this.app);
        }
        else if (components[0] === "users" && compLength === 6) {
            subject = KiiUser.userWithID(components[1], this.app);
        }
        else if (components[0] === "things" && compLength === 6) {
            subject = KiiThing.thingWithID(components[1], this.app);
        }
        else if (compLength !== 4) {
            throw new InvalidURIException(undefined, this);
        }
        const bucket = new KiiBucket(bucketName, subject, this.app);
    ...
    _userWithLoginName(loginName) {
        return __awaiter(this, void 0, void 0, function* () {
            return KiiUser.findUserByUsernameWithoutLogin(loginName, this.app);
        });
    }
    // FIXME: unused?
    // _getId() {
    ...
    groupWithID(groupID) {
        ...
        const group = KiiGroup.groupWithID(groupID, this.app);
        return group;
    }
    /**
    ...
    registerGroupWithOwnerAndID(groupID, groupName, owner, members) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield KiiGroup.registerGroupWithIDAndOwner(groupID, groupName, owner, members, this.app);
        });
    }
    /**
    ...
    groupWithURI(groupUri) {
        ...
        const group = KiiGroup.groupWithID(components[1], this.app);
        return group;
    }
    /**
    ...
    findUserByEmail(email) {
        return __awaiter(this, void 0, void 0, function* () {
            return KiiUser.findUserByEmailWithoutLogin(email, this.app);
        });
    }
    /**
    ...
    findUserByPhone(phone) {
        return __awaiter(this, void 0, void 0, function* () {
            return KiiUser.findUserByPhoneWithoutLogin(phone, this.app);
        });
    }
    /**
    ...
    findUserByUsername(username) {
        return __awaiter(this, void 0, void 0, function* () {
            return KiiUser.findUserByUsernameWithoutLogin(username, this.app);
        });
    }
    /**
    ...
    registerThing(fields) {
        return __awaiter(this, void 0, void 0, function* () {
            return KiiThing.register(fields, this.app);
        });
    }
    /**
    ...
    registerOwnerWithThingID(thingID, owner) {
        return __awaiter(this, void 0, void 0, function* () {
            return KiiThing.registerOwnerWithThingID(thingID, owner, this.app);
        });
    }
    /**
    ...
    registerOwnerWithThingIDAndPassword(thingID, owner, password) {
        return __awaiter(this, void 0, void 0, function* () {
            return KiiThing.registerOwnerWithThingIDAndPassword(thingID, owner, password, this.app);
        });
    }
    /**
     * Register user/group as owner of specified thing by app admin.
    ...
    registerOwnerWithVendorThingID(vendorThingID, owner) {
        return KiiThing.registerOwnerWithVendorThingID(vendorThingID, owner, this.app);
    }
    /**
     * Register user/group as owner of specified thing with password by app admin.
     *
    ...
    registerOwnerWithVendorThingIDAndPassword(vendorThingID, owner, password) {
        return KiiThing.registerOwnerWithVendorThingIDAndPassword(vendorThingID, owner, password, this.app);
    }
    /**
     ...
     */
    thingWithID(thingID) {
        return KiiThing.thingWithID(thingID, this.app);
    }
    /**
    ...
    loadThingWithVendorThingID(vendorThingID) {
        return __awaiter(this, void 0, void 0, function* () {
            return KiiThing.loadWithVendorThingID(vendorThingID, this.app);
        });
    }
    /**
    ...
    loadThingWithThingID(thingID) {
        ...
        const ret = new KiiThing(fields, this.app);
        return ret.refresh();
    }
    /**
    ...
    topicWithName(topicName) {
        return new KiiTopic("", topicName, this.app);
    }
