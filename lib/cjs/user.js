...
class KiiUser {
     ...
     */
    setCountry(value) {
        if (!this.country || !utilities_1.validateCountryCode(this.country)) {
            throw new exception_1.InvalidCountryException(undefined, undefined);
        }
        this.country = value;
    }
    /**
    ...
    pushInstallation() {
        if (this.app.isAdmin()) {
            throw new exception_1.UnsupportedOperationException("UnsupportedOperationException: Push installation is not supported by admin context", this);
        }
    ...
    setLocalPhone(phone, country) {
        ...
        if (utilities_1.validateCountryCode(country)) {
            ...
            throw new exception_1.InvalidCountryException("Invalid Coruntry", this);
        }
    }
    /** @hidden */
