...
exports.KiiServerCodeExecResult = exports.KiiServerCodeEntry = void 0;
...
class KiiServerCodeEntry {
    ...
    execute(argument) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!utilities_2.validateServerCodeEntryArgument(argument)) {
                throw new exception_1.InvalidArgumentException("arugment is invalid", this);
            }
            ...
            if (httpResponse_1.isSuccess(response.status)) {
                ...
                if (headers == null) {
                    throw utilities_1.error("Invalid response header", this);
                }
...
exports.KiiServerCodeEntry = KiiServerCodeEntry;
/**
...
exports.KiiServerCodeExecResult = KiiServerCodeExecResult;
