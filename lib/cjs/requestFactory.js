...
exports.KiiFetchRequestFactory = exports.KiiJQueryRequestFactory = void 0;
...
exports.KiiJQueryRequestFactory = KiiJQueryRequestFactory;
class KiiFetchRequestFactory {
    create(method, url) {
        return new FetchRequest(method, url);
    }
}
exports.KiiFetchRequestFactory = KiiFetchRequestFactory;
class XHRRequest {
