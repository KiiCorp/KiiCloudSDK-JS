...
exports.KiiThingQueryResult = exports.KiiThingQuery = void 0;
...
class KiiThingQuery {
    ...
    constructor(owner, groups = null) {
        ...
        if (!owner && (!groups || groups.length == 0)) {
            throw new exception_1.InvalidArgumentException("Both the owner and groups parameter are optional, but at least one of them must be supplied.", undefined);
        }
        this.owner = owner;
        this.groups = groups;
        this.limit = 0;
    ...
    /** @hidden */
    static clone(obj) {
        if (!obj || typeof obj !== "object" || obj instanceof app_1.KiiApplication) {
            return obj;
        }
    ...
    dictValue() {
        ...
        if (ownerClauses.length == 0) {
            throw new exception_1.InvalidArgumentException("Query clause must include the 'contains' clause.", this);
        }
...
exports.KiiThingQuery = KiiThingQuery;
/**
    ...
    getNextResult() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.hasNext()) {
                ...
                throw utilities_1.error(message, this);
            }
            ...
            return thing_1.KiiThing.executeQuery(nextQuery);
        });
    }
}
exports.KiiThingQueryResult = KiiThingQueryResult;
