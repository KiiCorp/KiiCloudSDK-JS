...
exports.KiiPushMessageBuilder = exports.KiiTopic = void 0;
    ...
    exists() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (httpResponse_1.isSuccess(response.status)) {
                ...
                const e = exception_1.parseErrorResponse(request, response, this, null);
...
exports.KiiPushMessageBuilder = KiiPushMessageBuilder;
