...
KiiErrorParser.parse = (error) => {
    ...
    // fix "invalid_grant" only case.
        ...
        for (let pattern of [
            exports.REG_SERVER_ERROR_KII_XHR_WRAPPER,
            exports.REG_SERVER_ERROR_KII_USER_OR_OBJECT,
            exports.REG_SERVER_ERROR_KII_SERVER_CODE,
            exports.REG_SERVER_ERROR_KII_SERVER_CODE_VERSION_NOT_FOUND,
        ]) {
