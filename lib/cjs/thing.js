...
class KiiThing {
    /** @hidden */
    constructor(fields = null, app = app_1.KiiApplication.globalApp) {
        this.fields = fields;
        this.app = app;
        this.online = null;
     ...
     * ```
     */
    static register(fields, app = app_1.KiiApplication.globalApp) {
     ...
     *   </ul>
     */
    static executeQuery(thingQuery, app = app_1.KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!thingQuery) {
                throw utilities_1.error("thingQuery is null", this);
            }
            ...
            const queryResult = new thingQuery_1.KiiThingQueryResult(thingQuery, things, respJson.nextPaginationKey);
            return queryResult;
        });
    }
    /**
     ...
     * ```
     */
    static registerOwnerWithThingID(thingID, owner, app = app_1.KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * ```
     */
    static registerOwnerWithThingIDAndPassword(thingID, owner, password, app = app_1.KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * ```
     */
    static registerOwnerWithVendorThingID(vendorThingID, owner, app = app_1.KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!utilities_1.isNonEmptyString(vendorThingID)) {
     ...
     * ```
     */
    static registerOwnerWithVendorThingIDAndPassword(vendorThingID, owner, password, app = app_1.KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!utilities_1.isNonEmptyString(vendorThingID)) {
                throw utilities_1.error("identifier is null or empty", undefined);
            }
            return KiiThing.registerOwnerWithIdentifierAndPassword("VENDOR_THING_ID:" + vendorThingID, owner, password, app);
        });
    }
    static registerOwnerWithIdentifier(identifier, owner, app = app_1.KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!identifier) {
                throw utilities_1.error("identifier is null or empty", undefined);
            }
            if (!owner) {
                throw utilities_1.error("owner is null", undefined);
            }
    ...
    static registerOwnerWithIdentifierAndPassword(identifier, owner, password, app = app_1.KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!identifier) {
                throw utilities_1.error("identifier is null or empty", undefined);
            }
            if (!password) {
                throw utilities_1.error("password is null or empty", undefined);
            }
            if (!owner) {
                throw utilities_1.error("owner is null", undefined);
            }
            ...
            if (owner instanceof user_1.KiiUser) {
                requestBody.userID = owner.getID();
            }
            else if (owner instanceof group_1.KiiGroup) {
    ...
    getOwnerURL(identifier, owner, injectedApp = null) {
        ...
        if (owner instanceof user_1.KiiUser) {
            ...
            throw utilities_1.error("owner should be instance of user or group", this);
        }
        if (!oid) {
            throw utilities_1.error("owner instance does not have id", this);
        }
    ...
    updatePassword(newPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.app.isAdmin()) {
                throw utilities_1.error("updatePassword can be used only by app admin.", this);
            }
            if (!newPassword) {
                throw new exception_1.InvalidArgumentException("newPassword is null or empty", this);
            }
     ...
     * ```
     */
    static loadWithVendorThingID(vendorThingID, app = app_1.KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * ```
     */
    static loadWithThingID(thingID, app = app_1.KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
            return KiiThing.load(thingID, app);
        });
    }
    static load(qualifiedID, app = app_1.KiiApplication.globalApp) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    bucketWithName(bucketName) {
        return new bucket_1.KiiBucket(bucketName, this, this.app);
    }
    /**
    ...
    topicWithName(topicName) {
        if (typeof topicName !== "string" || topicName === "") {
            throw utilities_1.error("topicName should not null or empty", this);
        }
        return new topic_1.KiiTopic(this.getPath(), topicName, this.app);
    }
    /**
    ...
    /** @hidden */
    getHttpURI() {
        return `${kii_1.Kii.getBaseURL()}/apps/${this.app.getAppID()}/things/${this.getThingID()}`;
    }
    /**
     * @hidden used from appAdminContext
     */
    static thingWithID(thingID, app = app_1.KiiApplication.globalApp) {
        if (!thingID) {
            throw new exception_1.InvalidArgumentException("thingID should not null or empty", undefined);
        }
