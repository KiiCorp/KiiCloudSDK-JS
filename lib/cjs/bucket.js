...
exports.KiiEncryptedBucket = exports.KiiBucket = void 0;
const _1 = require(".");
...
class KiiBucket {
    ...
    constructor(bucketName, parent, app) {
        ...
        this.app = app;
        if (!bucketName) {
            throw new exception_1.InvalidArgumentException("Specified bucket name is null or empty.", undefined);
        }
    }
    parentIs(parent, cls) {
    ...
    /** @hidden */
    getUser() {
        if (this.parentIs(this.parent, user_1.KiiUser)) {
            return this.parent;
        }
        return undefined;
    }
    /** @hidden */
    getGroup() {
        if (this.parentIs(this.parent, group_1.KiiGroup)) {
            return this.parent;
        }
        return undefined;
    }
    /** @hidden */
    getThing() {
        if (this.parentIs(this.parent, thing_1.KiiThing)) {
            return this.parent;
        }
        return undefined;
    }
     ...
     */
    createObject() {
        return new object_1.KiiObject(this, undefined, this.app);
    }
    /**
    ...
    createObjectWithType(type) {
        return object_1.KiiObject.objectWithBucket(this, type, this.app);
    }
    /**
    ...
    createObjectWithID(objectID) {
        if (!object_1.KiiObject.isValidObjectID(objectID)) {
            throw new exception_1.InvalidArgumentException("Specified obejctID is invalid.", this);
        }
        return new object_1.KiiObject(this, objectID, this.app);
    }
    /** @hidden */
    getPath() {
        if (this.parent == null) {
     ...
     */
    acl() {
        return _1.KiiACL.aclWithParent(this, this.app);
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (httpResponse_1.isSuccess(response.status)) {
                ...
                if (response.body["nextPaginationKey"] != null) {
                    nextQuery = query_1.KiiQuery.clone(query);
    ...
    countWithQuery(query) {
        return __awaiter(this, void 0, void 0, function* () {
            const url = `/apps/${this.app.getAppID()}${this.getPath()}/query`;
            const body = query == null ? query_1.KiiQuery.queryWithClause(null).toDict() : query.toDict();
    ...
    count() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.countWithQuery(query_1.KiiQuery.queryWithClause(null));
        });
    }
    /**
...
exports.KiiEncryptedBucket = KiiEncryptedBucket;
