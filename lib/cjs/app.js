...
class KiiApplication {
    ...
    bucketWithName(bucketName) {
        return new bucket_1.KiiBucket(bucketName, null, this);
    }
    /**
    ...
    encryptedBucketWithName(bucketName) {
        return new bucket_1.KiiEncryptedBucket(bucketName, null, this);
    }
    /**
    ...
    groupWithName(groupName) {
        return group_1.KiiGroup.groupWithJSON({ name: groupName }, this);
    }
    /** @hidden */
    ...
    listTopics(paginationKey = "") {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const items = topics.map((topic) => {
                return new topic_1.KiiTopic("", topic["topicID"], this);
            });
            return [items, nextPaginationKey];
        });
    }
}
exports.KiiApplication = KiiApplication;
const createDefaultClientFactory = () => {
    if (global.jQuery !== undefined) {
        return new requestFactory_1.KiiJQueryRequestFactory();
    }
    else if (global.fetch !== undefined) {
        return new requestFactory_1.KiiFetchRequestFactory();
    }
    else {
