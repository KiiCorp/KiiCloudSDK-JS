...
root.KiiGroup = (function() {
  ...
  function KiiGroup() {
    ...
    this._saveWithOwnerUsingCallbacks = bind(this._saveWithOwnerUsingCallbacks, this);
    this.saveWithOwner = bind(this.saveWithOwner, this);
    this._saveUsingCallbacks = bind(this._saveUsingCallbacks, this);
    this.save = bind(this.save, this);
    ...
    this._changeOwner = bind(this._changeOwner, this);
  ...
  KiiGroup.registerGroupWithID = function(groupID, groupName, members, callbacks) {
    return new Promise(function(resolve, reject) {
      var ref, ref1, registerGroupWithIDCallbacks;
      ...
      return KiiGroup._registerGroupWithIDUsingCallbacks((ref = root.KiiUser.getCurrentUser()) != null ? ref.getAccessToken() : void 0, groupID, groupName, (ref1 = root.Kii.getCurrentUser()) != null ? ref1.getID() : void 0, members, registerGroupWithIDCallbacks);
    });
  };

  KiiGroup._registerGroupWithIDUsingCallbacks = function(token, groupID, groupName, owner, members, callbacks) {
    var data, i, j, len, member, memberIDs, requestCallbacks, url, wrapper, xhr;
    ...
    if ((members != null) && members.length > 0) {
      memberIDs = [];
      for (i = j = 0, len = members.length; j < len; i = ++j) {
        member = members[i];
...
root.KiiObject = (function() {
  ...
  function KiiObject() {
    ...
    this._updateWithJSON = bind(this._updateWithJSON, this);
    this._convertToObjectType = bind(this._convertToObjectType, this);
    this.objectURI = bind(this.objectURI, this);
...
root.KiiAppAdminContext = (function() {
  function KiiAppAdminContext(spec) {
    ...
    this.registerGroupWithOwnerAndID = bind(this.registerGroupWithOwnerAndID, this);
    this._getToken = bind(this._getToken, this);
