...
if (b && module.exports) {
  module.exports = {
    exportedClasses: ['KiiPushSubscriptionWithToken', 'KiiPushSubscription', 'KiiThingQuery', 'KiiUserWithToken', 'KiiTopic', 'KiiPushMessageBuilder', 'KiiObjectWithToken', 'KiiEncryptedBucket', 'KiiSCNRenRen', 'KiiGroupWithToken', 'KiiObject', 'KiiSocialConnectNetwork', 'KiiThingContext', 'KiiBucketWithToken', 'KiiSocialConnect', 'KiiBucket', 'KiiAnalytics', 'KiiQuery', 'KiiSCNGoogle', 'KiiPushInstallation', 'KiiThing', 'KiiServerCodeEntry', 'KiiSCNTwitter', 'KiiGeoPoint', 'KiiClause', 'KiiACL', 'KiiSCNFacebook', 'KiiSDKClientInfo', 'KiiErrorParser', 'KiiAnonymousUser', 'KiiSCNQQ', 'KiiThingWithToken', 'KiiThingQueryResult', 'KiiACLEntry', 'KiiPushInstallationWithToken', 'KiiUser', 'KiiUserBuilder', 'KiiEncryptedBucketWithToken', 'KiiAppAdminContext', 'KiiServerCodeExecResult', 'KiiTopicWithToken', 'Kii', 'KiiAnyAuthenticatedUser', 'KiiGroup', 'ForTest', 'KiiACLWithToken', 'KiiAnalyticsSite', 'InvalidDisplayNameException', 'InvalidPasswordException', 'InvalidUsernameException', 'InvalidUserIdentifierException', 'InvalidEmailException', 'InvalidPhoneNumberException', 'InvalidLocalPhoneNumberException', 'InvalidCountryException', 'InvalidURIException', 'InvalidACLAction', 'InvalidACLSubject', 'InvalidACLGrant', 'InvalidLimitException', 'InvalidArgumentException', 'IllegalStateException', 'ArithmeticException', 'UnsupportedOperationException', 'KiiACLAction', 'KiiSocialNetworkName', 'KiiSite', 'KiiServerCodeEnvironmentVersion', '_KiiHttpRequestType'],
    create: function() {
