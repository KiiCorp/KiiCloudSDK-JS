...
if (b && module.exports) {
  module.exports = {
    exportedClasses: ['KiiTopic', 'KiiPushMessageBuilder', 'KiiBucket', 'KiiPushInstallationWithToken', 'KiiGroup', 'KiiThingQueryResult', 'KiiServerCodeEntry', 'KiiAnonymousUser', 'ForTest', 'KiiACLWithToken', 'KiiPushSubscriptionWithToken', 'KiiObject', 'KiiThingQuery', 'KiiUserBuilder', 'Kii', 'KiiACLEntry', 'KiiObjectWithToken', 'KiiEncryptedBucket', 'KiiSCNFacebook', 'KiiTopicWithToken', 'KiiThingWithToken', 'KiiPushInstallation', 'KiiACL', 'KiiSocialConnectNetwork', 'KiiPushSubscription', 'KiiGroupWithToken', 'KiiSCNGoogle', 'KiiAnalytics', 'KiiSCNQQ', 'KiiSocialConnect', 'KiiAnyAuthenticatedUser', 'KiiErrorParser', 'KiiBucketWithToken', 'KiiQuery', 'KiiSCNTwitter', 'KiiUserWithToken', 'KiiServerCodeExecResult', 'KiiSCNRenRen', 'KiiUser', 'KiiSDKClientInfo', 'KiiClause', 'KiiGeoPoint', 'KiiEncryptedBucketWithToken', 'KiiThing', 'KiiAppAdminContext', 'KiiThingContext', 'KiiSocialNetworkName', 'KiiSite', 'KiiServerCodeEnvironmentVersion', '_KiiHttpRequestType', 'KiiACLAction', 'InvalidDisplayNameException', 'InvalidPasswordException', 'InvalidUsernameException', 'InvalidUserIdentifierException', 'InvalidEmailException', 'InvalidPhoneNumberException', 'InvalidLocalPhoneNumberException', 'InvalidCountryException', 'InvalidURIException', 'InvalidACLAction', 'InvalidACLSubject', 'InvalidACLGrant', 'InvalidLimitException', 'InvalidArgumentException', 'IllegalStateException', 'ArithmeticException', 'UnsupportedOperationException', 'KiiAnalyticsSite'],
    create: function() {
