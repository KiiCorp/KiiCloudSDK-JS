...
if (b && module.exports) {
  module.exports = {
    exportedClasses: ['KiiUser', 'KiiServerCodeExecResult', 'KiiObjectWithToken', 'KiiAnyAuthenticatedUser', 'KiiThingWithToken', 'KiiEncryptedBucket', 'KiiAppAdminContext', 'KiiQuery', 'KiiPushSubscriptionWithToken', 'KiiSDKClientInfo', 'KiiGroupWithToken', 'KiiACL', 'KiiSocialConnectNetwork', 'KiiBucket', 'KiiServerCodeEntry', 'KiiThing', 'KiiPushInstallation', 'KiiThingContext', 'KiiSCNTwitter', 'KiiPushSubscription', 'KiiTopicWithToken', 'KiiPushInstallationWithToken', 'KiiObject', 'KiiBucketWithToken', 'Kii', 'KiiUserBuilder', 'KiiEncryptedBucketWithToken', 'KiiAnonymousUser', 'KiiSocialConnect', 'KiiGroup', 'KiiSCNQQ', 'KiiACLWithToken', 'ForTest', 'KiiGeoPoint', 'KiiUserWithToken', 'KiiSCNRenRen', 'KiiAnalytics', 'KiiTopic', 'KiiPushMessageBuilder', 'KiiClause', 'KiiACLEntry', 'KiiSCNGoogle', 'KiiSCNFacebook', 'KiiSocialNetworkName', 'KiiSite', '_KiiHttpRequestType', 'KiiAnalyticsSite', 'InvalidDisplayNameException', 'InvalidPasswordException', 'InvalidUsernameException', 'InvalidUserIdentifierException', 'InvalidEmailException', 'InvalidPhoneNumberException', 'InvalidLocalPhoneNumberException', 'InvalidCountryException', 'InvalidURIException', 'InvalidACLAction', 'InvalidACLSubject', 'InvalidACLGrant', 'InvalidLimitException', 'InvalidArgumentException', 'IllegalStateException', 'ArithmeticException', 'UnsupportedOperationException', 'KiiACLAction'],
    create: function() {
