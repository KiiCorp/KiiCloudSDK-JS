...
root.KiiUserAdmin = (function(_super) {
  ...
  KiiUserAdmin.prototype.pushInstallation = function() {
...
root.KiiThingAdmin = (function(_super) {
  __extends(KiiThingAdmin, _super);
...
root.KiiTopicAdmin = (function(_super) {
  __extends(KiiTopicAdmin, _super);
...
root.KiiPushSubscriptionAdmin = (function(_super) {
  __extends(KiiPushSubscriptionAdmin, _super);
...
if (b && module.exports) {
  module.exports = {
    exportedClasses: ['KiiUser', 'KiiServerCodeExecResult', 'KiiAnyAuthenticatedUser', 'KiiEncryptedBucket', 'KiiAppAdminContext', 'KiiQuery', 'KiiTopicAdmin', 'KiiSDKClientInfo', 'KiiACL', 'KiiSocialConnectNetwork', 'KiiBucket', 'KiiServerCodeEntry', 'KiiThingAdmin', 'KiiThing', 'KiiPushInstallation', 'KiiPushSubscriptionAdmin', 'KiiObjectAdmin', 'KiiSCNTwitter', 'KiiPushSubscription', 'KiiObject', 'Kii', 'KiiUserBuilder', 'KiiAnonymousUser', 'KiiSocialConnect', 'KiiGroup', 'KiiSCNQQ', 'ForTest', 'KiiACLAdmin', 'KiiGeoPoint', 'KiiSCNRenRen', 'KiiGroupAdmin', 'KiiBucketAdmin', 'KiiUserAdmin', 'KiiAnalytics', 'KiiEncryptedBucketAdmin', 'KiiTopic', 'KiiPushMessageBuilder', 'KiiClause', 'KiiACLEntry', 'KiiSCNGoogle', 'KiiSCNFacebook', 'KiiSocialNetworkName', 'KiiSite', '_KiiHttpRequestType', 'KiiAnalyticsSite', 'InvalidDisplayNameException', 'InvalidPasswordException', 'InvalidUsernameException', 'InvalidUserIdentifierException', 'InvalidEmailException', 'InvalidPhoneNumberException', 'InvalidLocalPhoneNumberException', 'InvalidCountryException', 'InvalidURIException', 'InvalidACLAction', 'InvalidACLSubject', 'InvalidACLGrant', 'InvalidLimitException', 'InvalidArgumentException', 'IllegalStateException', 'ArithmeticException', 'UnsupportedOperationException', 'KiiACLAction'],
    create: function() {
